...
$(function() {
	...
	var makeItemBoxes = function(feedData) {
		...
		for ( var attr in feedData) {
			...
			var itemHtml = "<div class='author'><a class='profileImg' href='/user/"+feedData[attr].uploader+"'><img src='"+feedData[attr].uploaderProfile+"' /></a><div class='name'><p class='uploader nickname'>" + feedData[attr].uploader+"</p><p class='uploadTime datetime'>"+feedData[attr].uploadTime+"</p></div>"
